...
SEMINIB _kernel_aseminib_table[200];
...
FLGINIB _kernel_aflginib_table[200];
...
DTQINIB _kernel_adtqinib_table[200];
...
MTXINIB _kernel_amtxinib_table[200];
